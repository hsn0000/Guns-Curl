...
class Curl
{
    ...
    /**
     * @var mixed info from curl exec
     */
    protected $curl_info;
    /**
     * @var string post data variable
     */
    protected $post_data = '';
    /**
     * @var string curl type
     */
    protected $curl_type = 'GET';
    ...
    protected function exec()
    {
        ...
        $log = array(
            ...
            'curl' => array(
                ...
                'response_code' => $this->http_status_code,
                'response' => $this->response,
                'response_header' => $this->response_headers,
                'info' => $this->curl_info,
                'error' => array(
                    'error' => $this->error,
     ...
     * @param mixed $value The value for the given header key
     * @return self
     */
